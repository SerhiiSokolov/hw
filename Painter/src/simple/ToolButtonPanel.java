...
/*----------------------------------------------------------------------------*/		 
		lineBtn			= new JButton("",new ImageIcon("d:\\1\\lineBtn.gif"));
		squareBtn		= new JButton("",new ImageIcon("d:\\1\\squareBtn.gif"));
		ovalBtn	 		= new JButton("",new ImageIcon("d:\\1\\ovalBtn.gif"));
		polygonBtn		= new JButton("",new ImageIcon("d:\\1\\polygonBtn.gif"));
		roundRectBtn	= new JButton("",new ImageIcon("d:\\1\\roundRectBtn.gif"));
		freeHandBtn		= new JButton("",new ImageIcon("d:\\1\\freeHandBtn.gif"));
		undoBtn			= new JButton("",new ImageIcon("d:\\1\\undoBtn.gif"));
		redoBtn			= new JButton("",new ImageIcon("d:\\1\\redoBtn.gif"));
		clearBtn		= new JButton("",new ImageIcon("d:\\1\\clearBtn.gif"));
